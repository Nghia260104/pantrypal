      ...
      body: Obx(() =>
        Stack(
          children: [
                                      ...
                                      Stack(
                                        children: [
                                          ...
                                          Positioned(
                                            ...
                                            child: Container(
                                              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 4), // Padding inside the label
                                              decoration: BoxDecoration(
                                                color: colors.buttonColor, // Background color for the label
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(width: 8), // Add spacing between "includes" and recipes list
                                              // Recipes list
                                              Text(
            ...
            if (controller.selectedTab.value == 1 || controller.selectedTab.value == 0)
              Align(
